...
like any other. API-key callers are always scoped to their own consumer
regardless of the ``consumer`` query param (and cannot see LLM routes); JWT
callers get the same read/self scoping as the admin metrics endpoints.
"""
