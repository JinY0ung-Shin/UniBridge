...
- **Runtime config**: API base / Keycloak settings come from runtime-injected config, not
  Vite build-time env. Build output is static; the container fills config at start.
